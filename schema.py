...
def RequestType():
  ...
  "properties": {
    "device_identity": {
      "type": "string",
      "description": "The identity of the device making the request."
    },
    "antenna_characteristics": {
      "type": "string",
      "description": "The characteristics of the device's antenna."
    },
    "power_level": {
      "type": "string",
      "description": "The power level of the device."
    },
    ...
    "spectrum_range": {
      "type": "string",
      "description": "The range of the spectrum the device is requesting to use."
    },
    "request_time": {
      "type": "string",
      "description": "The time the request is made."
    },
    "duration": {
      "type": "string",
      "description": "The duration for which the device is requesting to use the spectrum."
    }
  },
  "required": ["device_identity", "antenna_characteristics", "power_level", "location_information"]
}
